...
import {SefazStatusService} from './../service/sefaz-status.service';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.findAll().subscribe(map => {
    ...
    this.service.topIndisponibilidade().subscribe(autorizadora => {
      this.autorizadoraTopDisponibilidade = autorizadora

      if (this.autorizadoraTopDisponibilidade === undefined || this.autorizadoraTopDisponibilidade === null) {
  ...
  mountListStatusAll(map : Object) {
    ...
    console.log(this.listStatusAllData);
  }
